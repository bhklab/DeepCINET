...
if __name__ == '__main__':
    ...
    for drug in ['5-Fluorouracil', 'AZD7762', 'AZD8055', 'Bortezomib', 'Crizotinib',
       'Dabrafenib', 'Dasatinib', 'Docetaxel', 'Erlotinib', 'Gefitinib',
       'Gemcitabine', 'Ibrutinib', 'JQ1 compound', 'Lapatinib', 'MK-2206',
       'Nilotinib', 'Paclitaxel', 'Pictilisib', 'PLX4720', 'Vincristine',
       'Vorinostat']:
        output_path = os.path.expandvars("${HOME}/Documents/DATA/UHN-Project/Genomic/Processed/GeneratedData/" + f'CTRPv2/train_test_{drug}')
        target_path = os.path.expandvars("${HOME}/Documents/DATA/UHN-Project/Genomic/Processed/GeneratedData/" +f'drug_response/drug_CTRPv2_{drug}.csv')
        features = pd.read_csv(os.path.expandvars("${HOME}/Documents/DATA/UHN-Project/Genomic/Processed/GeneratedData/" +f'L1000_gene_expression/gene_CTRPv2_{drug}.csv'))
        try:
