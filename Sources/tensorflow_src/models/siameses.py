...
class ScalarOnlySiamese_onelayerL2(BasicSiamese):
    def __init__(self, number_features: int, **kwargs):
        #: Radiomic features obtained with `PyRadiomics <https://github.com/Radiomics/pyradiomics>`_
        self.x_scalar = tf.placeholder(tf.float32, [None, number_features])
    ...
    def _dense(self, x: tf.Tensor, units: int, name: str, activation=None) -> tf.Tensor:
        return tf.layers.dense(
            x,
            units=units,
            activation=activation,
...
class ScalarOnlySiamese_onelayer(BasicSiamese):
    def __init__(self, number_features: int, **kwargs):
        #: Radiomic features obtained with `PyRadiomics <https://github.com/Radiomics/pyradiomics>`_
        self.x_scalar = tf.placeholder(tf.float32, [None, number_features])
...
class ScalarOnlySiamese_onelayer_L12(BasicSiamese):
    def __init__(self, number_features: int, **kwargs):
        #: Radiomic features obtained with `PyRadiomics <https://github.com/Radiomics/pyradiomics>`_
        self.x_scalar = tf.placeholder(tf.float32, [None, number_features])
    ...
    def _dense(self, x: tf.Tensor, units: int, name: str, activation=None) -> tf.Tensor:
        return tf.layers.dense(
            ...
            activation=activation,
            kernel_initializer=tf.contrib.layers.variance_scaling_initializer(seed=self.seed),
            kernel_regularizer=tf.contrib.layers.l1_l2_regularizer(scale_l1=self._regularization, scale_l2=self._dropout, scope=None),
            name=name
        )
...
class ScalarOnlySiamese_onelayerL1(BasicSiamese):
    def __init__(self, number_features: int, **kwargs):
        #: Radiomic features obtained with `PyRadiomics <https://github.com/Radiomics/pyradiomics>`_
        self.x_scalar = tf.placeholder(tf.float32, [None, number_features])
    ...
    def _dense(self, x: tf.Tensor, units: int, name: str, activation=None) -> tf.Tensor:
        return tf.layers.dense(
            ...
            activation=activation,
            kernel_initializer=tf.contrib.layers.variance_scaling_initializer(seed=self.seed),
            kernel_regularizer=tf.contrib.layers.l1_regularizer(self._regularization),
            name=name
        )
