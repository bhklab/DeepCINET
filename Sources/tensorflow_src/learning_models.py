...
def learningModel(cv_folds: int = 1,
    ...
    """
    print(cv_folds)
    results_path = pathlib.Path(os.path.join(results_path, "Learning"))
    ...
    if (read_splits):
        ...
        for i, (train_ids, test_ids, df_features) in enum_generator:
            ...
            train_pairs, test_pairs, mixed_pairs = dataset.create_train_test(train_data, test_data, random=False,  distance= 0.2)
